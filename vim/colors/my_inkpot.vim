...
if has("gui_running")
    ...
    exec "hi ColorColumn    cterm=NONE   ctermfg=" . <SID>X(85) . " ctermbg=" . <SID>X(81)
    exec "hi IncSearch      cterm=BOLD   ctermfg=" . <SID>X(80) . " ctermbg=" . <SID>X(73)
    exec "hi Search         cterm=NONE   ctermfg=" . <SID>X(80) . " ctermbg=65"
    ...
    exec "hi PreProc        cterm=NONE   ctermfg=" . <SID>X(74) . " ctermbg=" . "NONE"
    ...
    exec "hi Type           cterm=NONE   ctermfg=" . <SID>X(25) . " ctermbg=" . "NONE"
